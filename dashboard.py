...
function renderTeam(){
  ...
  return '<section>'+
    ...
    '<div class="pbody"><div>'+
      ...
      '<div class="mgroups"><div class="overline" style="margin:0 2px 4px">Rendimento por métrica'+qm('As barras das estatísticas mostram o desempenho no recorte de jogos selecionado comparado a um jogo típico da Copa: 0 = entre os mais fracos jogos-de-time, 50 = mediano, 100 = entre os melhores. Não muda se você seleciona 1 ou vários jogos. Já os índices (IFE, IDO, P de vitória, xGD) mostram a posição da seleção entre as '+ifeR.n+' do torneio (º).')+' <span style="text-transform:none;letter-spacing:0;color:var(--muted);font-weight:500">· estatísticas vs. jogo médio da Copa (0–100) · índices: ranking entre '+ifeR.n+'</span></div>'+groupsH+
